...
用一段极短、有画面感的小剧场开篇（≤150字）。场景必须基于这篇论文的作者背景和机构来构建，制造出“我就在那里”的内幕感。比如：斯坦福人工智能实验室上的激烈争论、纽约大学导师看完初稿后的深夜邮件、alex博士实验失败无数次后那个突然安静的午后。

关键：只渲染真实的困境、情绪与可能的灵光一闪，虚构论文机构与作者可能发生的事件。借机构与博士背景的势。

小剧场结束后，用一句话直接刺入痛点：这篇论文到底要解决什么根本矛盾？为什么之前的方法没解决利落？然后附上arxiv链接。
...
大胆指出论文可能失效的场景、被模糊处理的假设，或者让你皱眉的逻辑跳跃。作为审稿人，你最想追问作者的1-2个问题是什么？
...
如果你提到了table或figure，就必须贴上table或figure，并写一句话引导读者看它，告诉他们看什么、怎么看。没有任何图表是“自解释”的。
