...
### 标题：论文标题或者论文算法简略名称
### 一、痛点与根本问题
- 开头用一段极短的小剧场（≤150字）引出痛点。场景需基于这个论文的**真实作者和机构**虚构，制造内幕感，同时借势大牌机构背书。
- 小剧场结束后，用一句过渡，立刻接入以下清晰结构：
   - 一句话痛点（这篇论文解决什么问题？为什么重要？）
   - 根本矛盾（之前的方法为什么解决不好？）
   - 原文链接
- 小剧场要克制，不编造机构未做的事，只渲染情绪和困境。
...
- 如果你是审稿人，你最想追问作者的3个问题是什么？（如果你觉得需要追问则写，无需追问可以少写）

### 六、你的独立洞见与延伸思考
- 这篇论文让你想到了什么更深层的问题或机会？
- 可以如何改进或拓展它？有无跨界应用的可能？
- 如果这篇论文具有推进行业的价值，则对该方向未来1-3年发展的大胆预测，否则无需写。
